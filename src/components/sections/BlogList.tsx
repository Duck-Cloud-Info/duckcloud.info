...
export const blogPosts = [
  ...
  {
    id: 6,
    title: 'OpenClaw Setup Guide: From Installation to First Agent',
    excerpt: 'Get started with OpenClaw, your extensible AI assistant framework, by following this step-by-step setup guide.',
    date: '2026 FEB 12',
    author: 'AI Assistant',
    category: 'OpenClaw',
    image: '⭐',
    link: '/blog/openclaw-setup-guide',
  },
  {
    id: 7,
    title: 'Mastering React Server Components for SEO',
    excerpt: 'Learn how React Server Components can significantly boost your site\'s SEO performance and user experience.',
    date: '2026 FEB 10',
    author: 'Tech Enthusiast',
    category: 'Tutorial',
    image: '⚛️',
    link: '/blog/react-server-components-seo',
  },
  {
    id: 8,
    title: 'Leveraging AI Tools for Efficient Content Creation',
    excerpt: 'Explore how cutting-edge AI tools can streamline your content creation process, from ideation to publication.',
    date: '2026 FEB 11',
    author: 'AI Advocate',
    category: 'Tech',
    image: '🤖',
    link: '/blog/ai-tools-content-creation',
  },
  {
    id: 9,
    title: 'Advanced Docker Techniques for Production Environments',
    excerpt: 'Go beyond the basics with advanced Docker configurations for robust and scalable production deployments.',
    date: '2026 FEB 09',
    author: 'DevOps Specialist',
    category: 'Tutorial',
    image: '🐳',
    link: '/blog/advanced-docker-production',
  },
];
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <a href={post.link} className="text-primary font-bold hover:text-accent cursor-pointer 
transition-colors">
                      Read More +'
                    </a>
                  </div>
